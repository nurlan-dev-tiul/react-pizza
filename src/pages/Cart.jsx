...
const Cart = () => {
  ...
  const groupPizzaCart = Object.keys(items).map(key => {
        ...
        { totalCount ? (
          <div className="cart">
            <div className="cart__top">
              ...
              <div className="cart__clear" onClick={clearCartItem}>
            ...
            <div className="content__items">
              {
                groupPizzaCart.map((obj) => {
                  return <CartItem name={obj.name}
            ...
            <div className="cart__bottom">
              ...
              <div className="cart__bottom-buttons">
                ...
                <div onClick={() => alert('Если деньги есть купи мне тоже))))')} className="button pay-btn">
